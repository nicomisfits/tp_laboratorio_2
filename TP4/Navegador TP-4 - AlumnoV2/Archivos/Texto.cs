...
namespace Archivos
{
    public class Texto : IArchivo<string>
    {
        ...
        /// <summary>
        /// Guarda datos pasados por parametros en _archivo.
        /// </summary>
        ...
        public bool guardar(string datos)
        {
            try
            {
                ...
                {
                    StreamWriter archivoTxt = new StreamWriter(this._archivo, true);
                    archivoTxt.WriteLine(datos);
                    archivoTxt.Close();                    
                }
                else
                {
                    StreamWriter archivoTxt = new StreamWriter(this._archivo, false);
                    archivoTxt.WriteLine(datos);
                    archivoTxt.Close();
                }
                return true;
